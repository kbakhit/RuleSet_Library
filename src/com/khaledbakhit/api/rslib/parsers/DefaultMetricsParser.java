...
/**
 * Default library's implementation of the MetricsParser abstract class.
 * @author Khaled Bakhit
 * @since 4.0
 * @version 18/08/2013
 */
public class DefaultMetricsParser extends MetricsParser {
    ...
    {
        return new DefaultMetricsParser();
    }
